...
const AccountManagement = () => {
  ...
  return (
    <div className="space-y-6" data-testid="account-management-page">
      <div>
        <h1 className="text-4xl font-bold text-slate-800 mb-2">Account Management</h1>
      ...
      {user?.role === 'SuperUser' && (
        <div className="flex space-x-2 border-b pb-2">
          <Button
            ...
            className={activeTab === 'pending' ? 'bg-blue-500' : ''}
          >
          ...
          <Button
            ...
            className={activeTab === 'users' ? 'bg-blue-500' : ''}
          >
              ...
              <Card key={account.id} className="hover:shadow-lg transition-shadow border-l-4 border-l-yellow-500" data-testid={`account-card-${account.id}`}>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                      <p className="font-semibold text-slate-600">Role:</p>
                      <p className="text-slate-800">{account.role}</p>
                    </div>
                    <div>
                      <p className="font-semibold text-slate-600">Division:</p>
                      <p className="text-slate-800">{account.division}</p>
                    </div>
                  </div>
