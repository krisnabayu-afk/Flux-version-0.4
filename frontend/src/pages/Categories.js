    ...
    if (user?.role !== 'SuperUser') {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
                ...
                <p className="text-slate-500">Only SuperUser can manage activity categories.</p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6" data-testid="categories-page">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-4xl font-bold text-slate-800 mb-2">Activity Categories</h1>
                    <p className="text-slate-600">Manage activity categories for schedules and reports</p>
                </div>

                <Dialog open={open} onOpenChange={setOpen}>
                    <DialogTrigger asChild>
                        <Button className="bg-indigo-500 hover:bg-indigo-600" data-testid="add-category-button">
