    ...
    return (
        <div className="space-y-6" data-testid="categories-page">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-4xl font-bold text-white mb-2">Activity Categories</h1>
                    <p className="text-gray-400">Manage activity categories for schedules and reports</p>
                </div>
