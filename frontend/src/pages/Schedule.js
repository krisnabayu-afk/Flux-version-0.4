...
import { Plus, Upload, Download, Calendar as CalendarIcon, Edit, Trash2, ChevronLeft, ChevronRight, Clock, CheckCircle, XCircle, Play, Pause, MessageSquare, Check, ChevronsUpDown } from 'lucide-react';
                            ...
                            <div className="flex justify-between items-start">
                              <div className="flex-1">
                                ...
                                {update.image_data && (
                                  <div className="mt-2">
                                    <img
                                      src={`data:image/jpeg;base64,${update.image_data}`}
                                      alt="Update attachment"
                                      className="max-h-40 rounded border border-slate-200 cursor-pointer hover:opacity-90"
                                      onClick={() => window.open(`data:image/jpeg;base64,${update.image_data}`, '_blank')}
                                    />
                                  </div>
                                )}
                              </div>
                              <span className="text-xs text-slate-400 whitespace-nowrap ml-2">
                                {moment(update.timestamp).format('HH:mm')}
                              </span>
                            </div>
                          </div>
                        ))}
