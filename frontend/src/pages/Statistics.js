...
const Statistics = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 py-4 overflow-x-auto">
                {/* Month Select */}
                <div className="w-[180px]">
                    <Select value={selectedMonth.toString()} onValueChange={(val) => setSelectedMonth(parseInt(val))}>
                        <SelectTrigger className="bg-transparent border-slate-700 hover:bg-slate-800/50">
